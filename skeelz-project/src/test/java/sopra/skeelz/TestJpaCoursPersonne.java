...
public class TestJpaCoursPersonne {
	...
	public void testCoursPersonneQuery() {
		...
		assertEquals("intituleCoursPersonneQuery" , CoursPersonneRepo.findCoursByIdPersonneEtatCours(personne.getId(), EtatCours.VALIDE).get(0).getIntitule());	
	}
	...
	public void testCoursPersonneController() {
		...
		assertEquals("intituleCoursPersonneCont" , coursPersonneCont.find(personne.getId(), EtatCours.VALIDE).get(0).getIntitule());	
