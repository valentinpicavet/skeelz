...
public class TestJpaElementDeCours {
	...
	public void testElementDeCoursQuery() {
		...
		assertEquals("paragraphe 1 test",
				((Paragraphe) elementDeCoursRepo.findElementDeCours(chapitre.getId()).get(0)).getTexte());
		assertEquals("paragraphe 1 test",
				((Paragraphe) elementDeCoursRepo.findElementDeCoursByChapitreAndAgencement(chapitre.getId(), 0))
						.getTexte());
	...
	public void testElementDeCoursCont() {
		...
		assertEquals("paragraphe 1 test",
				(((Paragraphe) elementDeCoursCont.findElementDeCoursByChapitreAndAgencement(chapitre.getId(), 0))
						.getTexte()));
